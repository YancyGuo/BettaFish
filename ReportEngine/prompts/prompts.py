...
可用模板类型：
- 游戏版本舆情演变分析报告模板：当需要分析特定游戏版本（如新版本发布、重大更新）发布前后的玩家舆论变化、口碑演变和舆情走向时，应选择此模板。核心任务是按时间线分析版本从预期到实际体验的舆情演变过程，重点关注玩家对版本内容、角色强度、活动质量、剧情评价等维度的讨论变化。特别适用于游戏版本更新前后的阶段性舆情分析。
